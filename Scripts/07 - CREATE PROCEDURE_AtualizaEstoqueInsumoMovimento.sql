...
BEGIN 
 ...
 INSERT INTO InsumoEstoque (insumo_id, fornecedor_id, usuario_id, quantidade_anterior, quantidade_entrada, quantidade_atual, tipoMovimento, dataMovimento, 	data_entrada, data_vencimento_estimado)
	select insumo_id = @insumo_id, fornecedor_id = @fornecedor_id, usuario_id = @usuario_id, quantidade_anterior = @quantidadeAnterior, quantidade_entrada = @quantidade, quantidade_atual = @quantidadeAtual, tipoMovimento = UPPER(@TipoMovimento),
...
BEGIN 
	...
	INSERT INTO InsumoEstoque (insumo_id, fornecedor_id, usuario_id, quantidade_anterior, quantidade_saida, quantidade_atual, tipoMovimento, dataMovimento, data_saida)
	select insumo_id = @insumo_id, fornecedor_id = @fornecedor_id, usuario_id = @usuario_id, quantidade_anterior = @quantidadeAnterior, quantidade_saida = @quantidade, quantidade_atual = @quantidadeAtual, tipoMovimento = UPPER(@TipoMovimento),
