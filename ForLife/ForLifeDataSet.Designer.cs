...
namespace ForLife {
    ...
    public partial class ForLifeDataSet : global::System.Data.DataSet {
        ...
        public partial class InsumoDataTable : global::System.Data.TypedTableBase<InsumoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public InsumoRow AddInsumoRow(string nome, string tipo, bool ativo, int periodo_vencimento, int usuario_id) {
...
namespace ForLife.ForLifeDataSetTableAdapters {
    ...
    public partial class InsumoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Insumo] WHERE (([id_insumo] = @Original_id_insumo) AND ([nome] = @Original_nome) AND ([tipo] = @Original_tipo) AND ([ativo] = @Original_ativo) AND ([periodo_vencimento] = @Original_periodo_vencimento) AND ([usuario_id] = @Original_usuario_id))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Insumo] ([nome], [tipo], [ativo], [periodo_vencimento], [usuario_id]) VALUES (@nome, @tipo, @ativo, @periodo_vencimento, @usuario_id);
SELECT id_insumo, nome, tipo, ativo, periodo_vencimento, usuario_id FROM Insumo WHERE (id_insumo = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Insumo] SET [nome] = @nome, [tipo] = @tipo, [ativo] = @ativo, [periodo_vencimento] = @periodo_vencimento, [usuario_id] = @usuario_id WHERE (([id_insumo] = @Original_id_insumo) AND ([nome] = @Original_nome) AND ([tipo] = @Original_tipo) AND ([ativo] = @Original_ativo) AND ([periodo_vencimento] = @Original_periodo_vencimento) AND ([usuario_id] = @Original_usuario_id));
SELECT id_insumo, nome, tipo, ativo, periodo_vencimento, usuario_id FROM Insumo WHERE (id_insumo = @id_insumo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ForLife.Properties.Settings.Default.ForLifeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_insumo, nome, tipo, ativo, periodo_vencimento, usuario_id FROM dbo.Insu" +
                "mo";
        ...
        public virtual int Delete(int Original_id_insumo, string Original_nome, string Original_tipo, bool Original_ativo, int Original_periodo_vencimento, int Original_usuario_id) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_periodo_vencimento));
        ...
        public virtual int Insert(string nome, string tipo, bool ativo, int periodo_vencimento, int usuario_id) {
            if ((nome == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(periodo_vencimento));
        ...
        public virtual int Update(string nome, string tipo, bool ativo, int periodo_vencimento, int usuario_id, int Original_id_insumo, string Original_nome, string Original_tipo, bool Original_ativo, int Original_periodo_vencimento, int Original_usuario_id, int id_insumo) {
            if ((nome == null)) {
                throw new global::System.ArgumentNullException("nome");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(periodo_vencimento));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_periodo_vencimento));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_usuario_id));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(id_insumo));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string tipo, bool ativo, int periodo_vencimento, int usuario_id, int Original_id_insumo, string Original_nome, string Original_tipo, bool Original_ativo, int Original_periodo_vencimento, int Original_usuario_id) {
            return this.Update(nome, tipo, ativo, periodo_vencimento, usuario_id, Original_id_insumo, Original_nome, Original_tipo, Original_ativo, Original_periodo_vencimento, Original_usuario_id, Original_id_insumo);
        }
    }
